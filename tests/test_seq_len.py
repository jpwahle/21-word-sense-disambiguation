...
def test_seq_len():
    ...
    for model_name_or_path in ['roberta-base', 'distilbert-base-uncased', 'albert-base-v2', 'facebook/bart-base', 'xlnet-base-cased', 'google/electra-base-discriminator']:
        ...
        for file in os.listdir(data_dir):
            with open(os.path.join(data_dir, file), "r", encoding="'iso-8859-1'") as f:
                ...
                print(result)    
                assert num_truncated/len(lengths) < 0.05
